...
use App\Modules\Catalog\Application\ArchiveMedicineAction;
use App\Modules\Catalog\Application\GetMedicineAction;
use Illuminate\Http\JsonResponse;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;

final class MedicineArchiveController
{
    public function __invoke(
        string $medicineId,
        ArchiveMedicineAction $archiveMedicine,
        ...
        $archiveMedicine->execute($parsedMedicineId);

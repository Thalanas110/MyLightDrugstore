...
use App\Modules\Inventory\Presentation\InventoryMovementListController;
...
Route::get('/inventory/lots', InventoryLotListController::class)
    ->middleware('auth:web')
...
Route::get('/inventory/movements', InventoryMovementListController::class)
    ->middleware('auth:web')
